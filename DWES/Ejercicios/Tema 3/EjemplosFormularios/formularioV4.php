...
<?php
        ...
        if($_POST) {
            ...
            //DISTINTAS FORMAS DE AFRONTAR UN MISMO PROBLEMA (decidir que funcion utilizar)
           ...
           // $errores['nombre'] = validar_string('nombre', 3, 20);
            ...
            //Funcion validar_string2 (utiliza un patron declarado fuera de la funcion)            
            //implemento mi patron personalizado 
            $patronN ="/^[a-zA-ZñáéíóúÁÉÍÓÚ ]{3,20}$/";
            $errores['nombre'] = validar_string2('nombre', $patronN);       
            
            $patronA ="/^[a-zA-ZñáéíóúÁÉÍÓÚ ]{3,50}$/";
            $errores['apellidos'] = validar_string2('apellidos', $patronA);      
                                                    
            //Funcion validar_string3 (utiliza un patron declarado dentro de la funcion)
            //$errores['nombre'] = validar_string3('nombre');
